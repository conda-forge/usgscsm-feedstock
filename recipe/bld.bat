...
REM The vendored csm installs csmapi.dll under %LIBRARY_LIB%. Also place it on
REM the dll search path so usgscsm.dll can load it at runtime.
copy csm\Release\csmapi.dll %LIBRARY_BIN%
if errorlevel 1 exit 1
